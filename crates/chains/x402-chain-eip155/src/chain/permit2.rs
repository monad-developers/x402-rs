...
mod tests {
    ...
    /// Any reorder of fields or rename in the upto `Witness` type
    /// would change the hash and break interop with `@x402/evm` clients.
    #[test]
    fn upto_witness_typehash_matches_onchain() {
        const EXPECTED: B256 =
            b256!("0xd4171c445a74218b01d4fd8af34ff1106580ea1e36ff837e64484bfaa2253b75");
        let computed =
            keccak256("Witness(address to,address facilitator,uint256 validAfter)".as_bytes());
